...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#5f9ea0", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#FFE6CC", textDisabled: "#BDC2C4", textSubtle: "#FFE6CC", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#FFE6CC", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#FFE6CC", tertiary: "#353547", text: "#add8e6", textDisabled: "#666171", textSubtle: "#add8e6", borderColor: "#524B63", card: "#27262c", gradients: {
